...
- **[ISO Format](https://www.loc.gov/preservation/digital/formats/fdd/fdd000079.shtml)**: Creates a sector-by-sector image of the disc, retaining all original data including menus, extras, and encryption layers. Best suited for full archiving or backup purposes, though it results in large files.[^lociso]
- **[MP4](https://www.loc.gov/preservation/digital/formats/fdd/fdd000155.shtml)**: A widely compatible container format well-suited for general viewing across devices and platforms. Supports lossy compression for reduced file sizes.[^locmp4]
- **[MKV (Matroska)](https://www.loc.gov/preservation/digital/formats/fdd/fdd000342.shtml)**: An open-standard container format capable of holding multiple video streams, audio tracks, and subtitle tracks. Preferred for high-quality archiving and media center use.[^locmkv]
