...
- **MicroLine/MicroRidge**: contact radii as small as 2.5 µm, approximating the shape of the cutting stylus itself and providing the most accurate tracing at inner grooves.

(Audio-Technica, n.d.-a; Soundsmith, n.d.)
...
The target resonance window is 8–12 Hz — above record-warp frequencies (2–5 Hz) and below the audible bass band (≥20 Hz). Below 8 Hz, warps excite the resonance, causing woofer pumping and groove-skipping; above 12 Hz, it colors the bass response (Vinyl Clear, n.d.; Sumiko, n.d.).
...
(Wikipedia, n.d.-a; Hydrogenaudio, n.d.)

## References

- AnalogMagik. (n.d.). *Anti-skate*. https://www.analogmagik.com/antiskate
- Audio-Technica. (n.d.-a). *Understanding the different stylus shapes*. https://www.audio-technica.com/en-eu/support/understanding-the-different-stylus-shapes
- Audio-Technica. (n.d.-b). *Anti-skate feature on turntable*. https://www.audio-technica.com/en-us/support/audio-solutions-question-week-anti-skate-feature-turntable-need-set/
- Cambridge Audio. (n.d.). *What is the difference between a moving magnet cartridge and a moving coil cartridge?* https://manuals.cambridgeaudio.com/en/alva-duo/what-difference-between-moving-magnet-cartridge-and-moving-coil-cartridge
- Hagerman Technology. (n.d.). *Cartridge loading*. https://www.hagtech.com/loading.html
- Howard, K. (n.d.). Cut and thrust: RIAA LP equalization. *Stereophile*. https://www.stereophile.com/features/cut_and_thrust_riaa_lp_equalization/index.html
- Hydrogenaudio. (n.d.). Myths (vinyl). *Hydrogenaudio Knowledgebase*. https://wiki.hydrogenaudio.org/index.php?title=Myths_(Vinyl)
- IEC 60098. (1987). *Analogue audio disk records and reproducing equipment*. International Electrotechnical Commission.
- Jovanovic, V. (2023). Tracing distortion on vinyl LPs. *Journal of the Audio Engineering Society*, *71*(10). https://www.aes.org/tmpFiles/elib/20251204/22236.pdf
- London Sound Academy. (2017). *How does vinyl work?* https://www.londonsoundacademy.com/blog/how-does-vinyl-work
- Nelson, C. S., & Stafford, J. W. (1964). The Westrex 3D StereoDisk system. *Journal of the Audio Engineering Society*, *12*(3).
- PS Audio. (2020, February 21). Secrets of the phono cartridge, part two. *Copper Magazine*. https://www.psaudio.com/blogs/copper/secrets-of-the-phono-cartridge-part-two
- Pspatial Audio. (n.d.-a). *Gramophone styli and groove dimensions*. http://pspatialaudio.com/stylus_grooves.htm
- Pspatial Audio. (n.d.-b). *Maximum recorded velocities*. https://pspatialaudio.com/max_velo.htm
- Pspatial Audio. (n.d.-c). *Disc-cutting lathes*. https://pspatialaudio.com/lathes.htm
- Pure-analogue.com. (n.d.). *The cutting lathe*. https://pure-analogue.com/the-cutting-lathe/
- RIAA. (n.d.). Bulletin E4: Dimensional standards for disc phonograph records. http://www.aardvarkmastering.com/riaa.htm
- RIAA. (1963). Bulletin E3: Standards for stereophonic disc records. http://www.aardvarkmastering.com/riaa.htm
- Soundsmith. (n.d.). *Stylus shape information*. https://www.sound-smith.com/articles/stylus-shape-information
- Sumiko. (n.d.). *Tonearm resonance*. https://sumikophonocartridges.com/tonearm-resonance/
- Vinyl Clear. (n.d.). Tonearm and cartridge resonance: A guide to better vinyl sound. *Vinyl Clear*. https://vinylclear.com/blogs/all-things-vinyl/tonearm-and-cartridge-resonance-a-guide-to-better-vinyl-sound
- Wikipedia. (n.d.-a). Phonograph record. *Wikipedia*. https://en.wikipedia.org/wiki/Phonograph_record
- Wikipedia. (n.d.-b). Vertical cut recording. *Wikipedia*. https://en.wikipedia.org/wiki/Vertical_cut_recording
- Wikipedia. (n.d.-c). RIAA equalization. *Wikipedia*. https://en.wikipedia.org/wiki/RIAA_equalization
