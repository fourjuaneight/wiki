...
- IEEE. (2006). *Milestones: Development of VHS, a world standard for home video recording, 1976*. Engineering and Technology History Wiki. https://web.archive.org/web/20230819212517/https://ethw.org/Milestones:Development_of_VHS,_a_World_Standard_for_Home_Video_Recording,_1976
- IEC. (1992). *IEC 60774-1: Magnetic tape cassette video recording and reproducing systems — Part 1: VHS system* (1st ed.). International Electrotechnical Commission.
- Lardner, J. (1987). *Fast forward: Hollywood, the Japanese, and the onslaught of the VCR*. W. W. Norton.
- Watkinson, J. (1994). *The art of digital video* (2nd ed.). Focal Press.
